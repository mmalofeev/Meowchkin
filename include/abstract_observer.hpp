...
public:
    ...
    virtual void on_levelup(std::size_t user_id) = 0;
    virtual void on_card_receive(std::size_t user_id) = 0;
    virtual void on_item_equip(std::size_t user_id) = 0;
    virtual void on_item_loss(std::size_t user_id) = 0;
